...
namespace AsyncWebClient.AsyncWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AsyncWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class AsyncWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AsyncWebService() {
            this.Url = global::AsyncWebClient.Properties.Settings.Default.AsyncWebClient_AsyncWebService_AsyncWebService;
        ...
        /// <remarks/>
        public void GetPageAsync(string url) {
            this.GetPageAsync(url, null);
        }
        
        /// <remarks/>
        public void GetPageAsync(string url, object userState) {
            ...
            this.InvokeAsync("GetPage", new object[] {
                        url}, this.GetPageOperationCompleted, userState);
        }
